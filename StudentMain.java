...
public class StudentMain extends JFrame implements ActionListener
{
	...
	public StudentMain(){}
	public StudentMain(String name)
	{
		super("Student Main");
		...
		type = new JLabel("Student Profile");
		...
		rbutton1 = new JRadioButton("Exam Routine");
		rbutton1.setBounds(150, 300, 400, 50);
		rbutton1.setBackground(Color.WHITE);
		panel1.add(rbutton1);
		
		rbutton2 = new JRadioButton("Quiz Schedule");
	...
	public void actionPerformed(ActionEvent a)
	{
		...
		if(btn.equals("Done"))
		{
			...
			{
				ExamRoutine ER = new ExamRoutine(name);
				ER.setVisible (true);
				this.setVisible(false);
			}
			else if(rbutton2.isSelected())
			{
				QuizSchedule QS = new QuizSchedule (name);
				QS.setVisible (true);
				this.setVisible(false);
			}
		}
